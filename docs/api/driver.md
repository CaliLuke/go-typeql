...
The bundled Rust FFI crate currently depends on the `typedb-driver` and `typeql` `3.12.0` Rust crates and is tested against the `typedb/typedb:3.12.1` server image.
