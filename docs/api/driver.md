...
The bundled Rust FFI crate currently depends on the `typedb-driver` `3.13.6` and `typeql` `3.13.4` Rust crates and is tested against the `typedb/typedb:3.13.6` server image.
