...
The bundled Rust FFI crate currently depends on the `typedb-driver` `3.12.3` and `typeql` `3.12.2` Rust crates and is tested against the `typedb/typedb:3.12.3` server image.
