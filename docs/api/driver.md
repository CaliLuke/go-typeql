...
The bundled Rust FFI crate currently depends on `typedb-driver` `3.11.1`, paired with `typeql` `3.11.0` and the `typedb/typedb:3.11.0-rc1` integration-test image.
