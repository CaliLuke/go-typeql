...
## func [ExtractAnnotations](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/annotations.go#L10>)
...
Render processes a ParsedSchema and writes the generated Go source code, gofmt\-formatted, to the provided writer. It returns an error when two schema labels would fold to the same Go identifier \(e.g. "user\-name" and "user\_name"\), since the generated code would not compile, and when the rendered output is not valid Go \(the raw output is still written so it can be inspected\). Non\-fatal issues \(unknown value types, undefined attributes, roles with no resolvable player, skipped functions\) are reported to cfg.WarnWriter \(os.Stderr by default\).

<a name="RenderDTO"></a>
## func [RenderDTO](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/dto.go#L426>)
...
## func [RenderLeafConstants](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L584>)
...
## func [RenderRegistry](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L563>)
...
<a name="Annotation"></a>
## type [Annotation](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L105-L119>)
...
<a name="AsClause"></a>
## type [AsClause](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L98-L100>)
...
<a name="AttrDef"></a>
## type [AttrDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L21-L29>)
...
<a name="CardAnnot"></a>
## type [CardAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L122-L124>)
...
<a name="DTOData"></a>
## type [DTOData](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/dto.go#L12-L46>)
...
### func [BuildDTOData](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/dto.go#L116>)
...
<a name="DocAnnot"></a>
## type [DocAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L168-L170>)
...
## type [EntityClause](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L49-L53>)
...
<a name="EntityDef"></a>
## type [EntityDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L32-L38>)
...
<a name="EnumCtx"></a>
## type [EnumCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L89>)
...
## type [EnumValueCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L92>)
...
<a name="FunBodyTok"></a>
## type [FunBodyTok](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L258-L260>)
...
<a name="FunDef"></a>
## type [FunDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L248-L251>)
...
## type [JSONSchemaCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L125-L129>)
...
## type [JSONSchemaPropCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L132-L135>)
...
<a name="KVCtx"></a>
## type [KVCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L95-L97>)
...
<a name="KVMapCtx"></a>
## type [KVMapCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L119-L122>)
...
<a name="KVSliceCtx"></a>
## type [KVSliceCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L100-L103>)
...
## type [LeafConstantsConfig](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L571-L578>)
...
<a name="MetaAnnot"></a>
## type [MetaAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L173-L176>)
...
<a name="OwnsDef"></a>
## type [OwnsDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L57-L61>)
...
### func [ParseSchema](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L202>)
...
### func [ParseSchemaFile](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L221>)
...
<a name="PlaysDef"></a>
## type [PlaysDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L64-L68>)
...
<a name="RangeAnnot"></a>
## type [RangeAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L141-L143>)
...
### func \(\*RangeAnnot\) [Expr](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L154>)
...
<a name="RangeTok"></a>
## type [RangeTok](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L147-L149>)
...
<a name="RegexAnnot"></a>
## type [RegexAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L127-L129>)
...
## type [RegistryData](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L40-L80>)
...
### func [BuildRegistryData](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L141>)
...
## type [RelSchemaCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L113-L116>)
...
<a name="RelatesDef"></a>
## type [RelatesDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L90-L95>)
...
## type [RelationClause](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L81-L86>)
...
## type [RelationDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L71-L77>)
...
<a name="RoleCtx"></a>
## type [RoleCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L106-L110>)
...
<a name="SimpleDef"></a>
## type [SimpleDef](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L238-L244>)
...
<a name="StructDefP"></a>
## type [StructDefP](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L181-L185>)
...
## type [StructFieldP](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L190-L195>)
...
<a name="SubClause"></a>
## type [SubClause](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L41-L44>)
...
## type [SubkeyAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L163-L165>)
...
## type [TQLFileSimple](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L232-L235>)
...
## type [TypeConstCtx](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/registry.go#L83-L86>)
...
## type [ValuesAnnot](<https://github.com/CaliLuke/go-typeql/blob/main/tqlgen/parser.go#L132-L134>)
